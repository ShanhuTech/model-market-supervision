...
@Module(description = "抓拍引擎")
public final class EngineCapture extends AbstractModule {
    ...
    public EngineCapture() {
    }

    public EngineCapture(final HttpServlet httpServlet, final HttpServletRequest httpServletRequest, final HttpServletResponse httpServletResponse, final HashMap<String, Object> parameter) throws Exception {
    ...
    @Method(description = "添加抓拍引擎", anonymousAccess = false, frequencys = {
        @Frequency(source = Frequency.Source.ACCOUNT, count = 10, unit = Frequency.Unit.SECOND) }, methodType = Method.Type.POST, parameters = {
            ...
            @Parameter(name = "process_number", text = "进程数", type = Parameter.Type.INTEGER, allowNull = false, format = "^[1-9]\\d*$", formatPrompt = "大于等于0的正整数", remark = ""),
    ...
    public final Message addEngineCapture() {
        try {
            ...
            final Integer processNumber = (Integer) this.getParameter(this.parameter, "process_number");
            ...
            // 添加抓拍引擎
            {
                ...
                try {
                    ...
                    final mms.dao.EngineCapture obj = new mms.dao.EngineCapture(con);
                    final Message resultMsg = obj.addEngineCapture(url, name, description, processNumber, version);
    ...
    @Method(description = "删除抓拍引擎", anonymousAccess = false, frequencys = { @Frequency(source = Frequency.Source.IP, count = 10, unit = Frequency.Unit.SECOND) }, methodType = Method.Type.POST, parameters = {
        @Parameter(name = "uuid_array", text = "抓拍引擎的uuid集合", type = Parameter.Type.STRING, allowNull = false, format = "^[0-9a-zA-Z]{1,40}(;[0-9a-zA-Z]{1,40})*$", formatPrompt = "以分号分割的1-40位的数字或大小写字母", remark = "") }, returns = @Returns())
    public final Message removeEngineCapture() {
        try {
            ...
            // 删除抓拍引擎
            {
                ...
                try {
                    con = DruidInstance.getInstance().getTransConnection();
                    final mms.dao.EngineCapture obj = new mms.dao.EngineCapture(con);
                    final Message resultMsg = obj.removeEngineCaptureByUuid(uuidArray);
                    this.messageResultHandler(resultMsg, con, true);
                    return resultMsg;
                } catch (final Exception e) {
                    return this.catchHandler(con, e);
    ...
    @Method(description = "修改抓拍引擎", anonymousAccess = false, frequencys = {
        @Frequency(source = Frequency.Source.ACCOUNT, count = 10, unit = Frequency.Unit.SECOND) }, methodType = Method.Type.POST, parameters = {
            @Parameter(name = "uuid", text = "待修改抓拍引擎的uuid", type = Parameter.Type.STRING, allowNull = false, format = "^[0-9a-zA-Z]{1,40}$", formatPrompt = "1-40位的数字或大小写字母", remark = ""),
            ...
            @Parameter(name = "process_number", text = "进程数", type = Parameter.Type.INTEGER, allowNull = true, format = "^[1-9]\\d*$", formatPrompt = "大于等于0的正整数", remark = ""),
    ...
    public final Message modifyEngineCapture() {
        try {
            ...
            // 修改抓拍引擎
            {
                ...
                try {
                    con = DruidInstance.getInstance().getTransConnection();
                    final mms.dao.EngineCapture obj = new mms.dao.EngineCapture(con);
                    final Message resultMsg = obj.modifyEngineCapture(uuid, url, name, description, processNumber, version);
                    this.messageResultHandler(resultMsg, con, true);
                    return resultMsg;
                } catch (final Exception e) {
                    return this.catchHandler(con, e);
    ...
    @Method(description = "获取抓拍引擎", anonymousAccess = false, frequencys = {
        @Frequency(source = Frequency.Source.ACCOUNT, count = 10, unit = Frequency.Unit.SECOND) }, methodType = Method.Type.POST, parameters = {
            @Parameter(name = "uuid_array", text = "抓拍引擎uuid的集合", type = Parameter.Type.STRING, allowNull = true, format = "^[0-9a-zA-Z]{1,40}(;[0-9a-zA-Z]{1,40})*$", formatPrompt = "以分号分割的1-40位的数字或大小写字母", remark = ""),
            ...
            @Parameter(name = "rows", text = "查询的行数", type = Parameter.Type.INTEGER, allowNull = true, format = "^[1-9]\\d*$", formatPrompt = "大于等于1的正整数", remark = "从1开始") }, returns = @Returns(results = {
                ...
                @ReturnResult(parentId = "array_id", id = "", name = "uuid", type = "string[1,40]", isNecessary = true, description = "抓拍引擎的uuid"),
                ...
                @ReturnResult(parentId = "array_id", id = "", name = "process_number", type = "int", isNecessary = true, description = "进程数"),
    ...
    public final Message getEngineCapture() {
        try {
            ...
            // 获取抓拍引擎
            {
                ...
                try {
                    con = DruidInstance.getInstance().getTransConnection();
                    final mms.dao.EngineCapture obj = new mms.dao.EngineCapture(con);
                    final Message resultMsg = obj.getEngineCapture(uuidArray, nameArray, nameLike, null, offset, rows);
                    this.messageResultHandler(resultMsg, con, true);
                    return resultMsg;
                } catch (final Exception e) {
                    return this.catchHandler(con, e);
